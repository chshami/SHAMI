...
$botNormal=array(
 " ShAmi BhAi "  <3 :* ιndependence a precιoυѕ gιғт oғ god. мay we alwayѕ reмaιn ιndependenт >>>AMEEN<<<
<3 A νєяу нαρρу ιη∂єρєη∂єη¢є ∂αу тσ уσυ ιη α∂ναη¢є <3 fяоm <3  <me> :) Bot Powered By <me> :) Contact me  03136927773 ",
);
...
$eps=$like.' '.$nm;
$ops=getJam($nm);
$site='For BOT Contact >>> fb.com/ShAmi BhAi';
$true=$ops.'
 '.$site;
